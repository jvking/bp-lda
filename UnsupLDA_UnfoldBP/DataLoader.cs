...
namespace BP_LDA
{
    public class DataLoader
    {
        ...
        //    // Read each line from the InputData file (tsv format) and store it into each column of the sparse matrix
        //    Console.WriteLine("Loading input data...");
        //    InputDataStream.BaseStream.Seek(0, SeekOrigin.Begin);
        //    nLine = 0;
        ...
        //        nNonzero = StrLineSplit.Length;
        //        nTotNonzero += nNonzero;
        //        int[] Key = new int[nNonzero];
        //        float[] Val = new float[nNonzero];
        ...
        //        }
        //        InputDataMatrix.FillColumn(Key, Val, nLine);
        ...
        //    Console.WriteLine("# Nonzeros = {0}/{1} ({2}%)", nTotNonzero, InputDataMatrix.nRows * InputDataMatrix.nCols, (((float)nTotNonzero) / ((float)InputDataMatrix.nRows * InputDataMatrix.nCols)) * 100);
        //    Console.WriteLine("==================================================");
